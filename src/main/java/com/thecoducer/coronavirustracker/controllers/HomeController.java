...
public class HomeController {
	...
	public String home(Model model) {
		...
		String totalIndiaNewCases = numberFormat.format(Integer.valueOf(indiaTotalCounterDataService.getTotalNewCases()));
		String totalIndiaActiveCases = numberFormat.format(Integer.valueOf(indiaTotalCounterDataService.getTotalActiveCases()));
		String totalIndiaRecoveredCases = numberFormat.format(Integer.valueOf(indiaTotalCounterDataService.getTotalRecoveredCases()));
		String totalIndiaNewRecoveredCases = numberFormat.format(Integer.valueOf(indiaTotalCounterDataService.getTotalNewRecoveredCases()));
		String totalIndiaNewDeaths = numberFormat.format(Integer.valueOf(indiaTotalCounterDataService.getTotalNewDeaths()));
